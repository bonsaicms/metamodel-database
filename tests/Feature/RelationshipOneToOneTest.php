...
it('creates foreign key in the right entity table when oneToOne relationship is created', function () {
...
it('deletes foreign key in the right entity table when oneToOne relationship is deleted', function () {
    Relationship::factory()
        ->for($this->entity1, 'leftEntity')
        ->for($this->entity2, 'rightEntity')
        ->create([
...
it('updates DB schema when oneToOne relationship is updated');
